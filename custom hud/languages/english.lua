...
languageTable.label = {
	...
	buttonActiveColor = 'Selected button active',
	buttonHoveredColor = 'Selected button hovered',
	buttonSelectedColor = 'Selected button',
	cancel = 'cancel',
	close = 'close',
	colorComponentWidth = 'Color component editor width',
	...
	dragFloatWidth = 'width of imgui.DragFloat',
	...
	h = 'Height',
	inlobby = 'in lobby',
	inputTextLength = 'imgui.InputText buffer size',
...
languageTable.message = {
	...
	saveFailed = 'Failed saving profile and options',
